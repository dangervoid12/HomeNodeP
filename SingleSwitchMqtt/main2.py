...
CONFIG = {
    "broker": "192.168.0.11",  //update here broker ip
    "switch_pin": 0, 
...
def setupMqtt():
   ...
   client = MQTTClient(CONFIG['client_id'], "io.adafruit.com",user="", password="", port=1883)  // for adafruit broker update name and pass
